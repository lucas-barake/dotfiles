...
3. If the shared checkout is on a different version, create a separate git worktree or isolated clone. If no matching upstream ref exists, use the installed package source as the version source of truth and record the mismatch
